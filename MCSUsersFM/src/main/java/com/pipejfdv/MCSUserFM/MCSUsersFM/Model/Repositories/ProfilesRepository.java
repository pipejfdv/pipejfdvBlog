...
/*
* Repository for managing Profile entity database operations
*/
@Repository
public interface ProfilesRepository extends JpaRepository<Profile, UUID> {
    ...
    /*
    * Lists all profiles associated with children of a specific guardian
    * @Param guardianId the guardian UUID
    * @Return list of profiles for the given guardian
    */
